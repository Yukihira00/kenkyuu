...
CONTENT_CATEGORIES = {
    ...
    "スポーツ、アウトドア、車": [
        ...
        "バイク", "スポーツ", "プロ野球", "MLB", "野球全般", "高校野球", "ソフトボール", "ゴルフ", "サッカー", "海外サッカー", "FIFAワールドカップ", "ラグビー、アメフト", "テニス", "ソフトテニス", "卓球", "バドミントン", "バレーボール", "バスケットボール", "ハンドボール", "ボウリング", "大相撲", "総合格闘技、K-1", "プロレス", "ボクシング", "格闘技、武術全般", "水泳", "ダイビング", "サーフィン", "マラソン、陸上競技", "体操", "スキー", "スノーボード", "スケート、アイスホッケー", "フィギュアスケート", "モータスポーツ", "トレーニング", "オリンピック", "パラリンピック",
        "自転車、サイクリング",
...
# 制約:
- 回答はJSONリストのみ。
- JSONオブジェクトの数は必ず{len(texts)}個。
- キー: content_category, expression_category, style_stance_category
